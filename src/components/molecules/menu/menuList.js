    ...
    <>
      ...
      <div className={showMenu ? "menu" : "menu hide"}>
        ...
        <div className='menu__arrow'>
          <i
            className='fas fa-angle-left menu__arrow--active'
            onClick={() => setShowMenu(!showMenu)}
          />
        </div>

        <section className='menu__logo container-logo'>
        ...
        <ul>
          <LiMenuTitle CURRENTMENU={MENU.INDICE.INDEX}>
            {" "}
          ...
          <ul
            className={
              props.currentMenu === MENU.INDICE.INDEX
                ? "sub-list--opened"
                : "sub-list"
            }
          >
            <LiMenuItem
              ...
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.PRODUCTO}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/client"}
              CURRENTMENU={MENU.INDICE.CLIENTE}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.PROVEEDOR}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.CATEGORIAS}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.MARCAS}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.MEDICION}
            >
            ...
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.INDICE.USUARIO}
            >
              <MaterialIcon icon='assignment' className='icon' />
            </LiMenuItem>
          </ul>

          <LiMenuTitle CURRENTMENU={MENU.PROCESOS.INDEX}>
            {" "}
            <FaCashRegister size='1.5em' />{" "}
          </LiMenuTitle>

          <ul
            className={
              props.currentMenu === MENU.PROCESOS.INDEX
                ? "sub-list--opened"
                : "sub-list"
            }
          >
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.PROCESOS.ENTRADAINVENTARIO}
            >
              <FaProductHunt icon='assignment' className='icon' />
            </LiMenuItem>
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.PROCESOS.REIMPRIMIRFACTURAS}
            >
              <IoIosPerson icon='assignment' className='icon' />
            </LiMenuItem>
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.PROCESOS.CAJONDINERO}
            >
              <IoIosBriefcase icon='assignment' className='icon' />
            </LiMenuItem>
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.PROCESOS.CORTECAJA}
            >
              <IoIosPaper icon='assignment' className='icon' />
            </LiMenuItem>
          </ul>

          <LiMenuTitle CURRENTMENU={MENU.CARTERA.INDEX}>
            {" "}
          ...
          <ul
            className={
              props.currentMenu === MENU.CARTERA.INDEX
                ? "sub-list--opened"
                : "sub-list"
            }
          >
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.CARTERA.CUENTASPORCOBRAR}
            >
              <FaProductHunt icon='assignment' className='icon' />
            </LiMenuItem>
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.CARTERA.CUENTASPORPAGAR}
            >
              <IoIosPerson icon='assignment' className='icon' />
            </LiMenuItem>
          </ul>

          <LiMenuTitle CURRENTMENU={MENU.REPORTES.INDEX}>
            <IoIosInformationCircle size='1.5em' />{" "}
          </LiMenuTitle>

          <ul
            className={
              props.currentMenu === MENU.REPORTES.INDEX
                ? "sub-list--opened"
                : "sub-list"
            }
          >
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.REPORTES.REPORTEINVENTARIO}
            >
              <FaProductHunt icon='assignment' className='icon' />
            </LiMenuItem>
            <LiMenuItem
              history={props.history}
              path={"/home/product"}
              CURRENTMENU={MENU.REPORTES.REPORTECONTABLE}
            >
              <FaProductHunt icon='assignment' className='icon' />
            </LiMenuItem>
          </ul>
